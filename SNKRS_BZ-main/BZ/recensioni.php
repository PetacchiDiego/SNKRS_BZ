...
<body>
			...
			<div class="carousel-inner">
				...
				<div class="box">
				  <div class="client_info">
					<div class="client_name">
					  ...
					  <h6>
						Appassionato di sneakers
					  </h6>
					</div>
					<i class="fa fa-quote-left" aria-hidden="true"></i>
				  </div>
				  <p>
					Se sei un appassionato di scarpe, sai quanto sia importante trovare il paio perfetto per ogni occasione. Ecco dove entra in gioco Snkrs BZ, un'oasi virtuale per gli amanti delle scarpe alla ricerca del paradiso dei calzaturifici online.
				  </p>
				</div>
			  </div>
			  <div class="carousel-item">
				<div class="box">
				  ...
				  <p>
					Snkrs BZ non delude mai quando si tratta di offerta. Con una selezione impressionante di marchi prestigiosi e stilisti emergenti, il sito offre una varietà di opzioni per soddisfare ogni stile e preferenza.
				  </p>
				</div>
			  </div>
			  <div class="carousel-item">
	...
	<!-- codice per far funzionare i commenti chaptGPT -->
	<script src="https://code.jquery.com/jquery-3.5.1.slim.min.js"></script>
	<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.5.3/dist/umd/popper.min.js"></script>
	<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>

	<!-- immagini -->
	<div class="container" style="padding: 0px; margin-bottom: 80px;">
		<img src="images/angoloSNKRS.jpg" style="width: 33%;" alt="" />
		<img src="images/monkler.jpg" style="width: 33%;" alt="" />
		<img src="images/maniSNKRS.jpg" style="width: 33%;" alt="" />
	</div>
